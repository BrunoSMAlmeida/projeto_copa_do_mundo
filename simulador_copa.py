...
class Team:
    ...
    def motivate(self):
        ...
        # self.lastMotivation = random.uniform(0, (self.score * 100) / Team.BEST_SCORE) -> Seleções aleatórias ganhar
...
# TODO: Criando variáveis para as 2 melhores seleções de cada grupo:
...
print('Resultados das Oitavas de finais')
...
print('Resultados das Quartas de finais')
...
print('Resultados da final e disputa de terceiro lugar')
